...
> 
> 有关 EventComponent 的详细信息，请参阅 [EventComponent](./5-api-reference.event-component) 文档。
> 
> 有关 GameEventArgs 的详细信息，请参阅 [GameEventArgs](./5-api-reference.game-event-args) 文档。
...
- [EventComponent](./5-api-reference.event-component) - Unity 组件封装
- [GameEventArgs](./5-api-reference.game-event-args) - 事件参数基类
- [核心概念：事件系统架构](../4-core-concepts.index) - 了解更多设计原理

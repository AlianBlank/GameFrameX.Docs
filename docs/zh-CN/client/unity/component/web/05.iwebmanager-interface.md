...
> **注意**：在 WebGL 平台上，证书验证默认被跳过以方便开发调试。生产环境如需启用证书验证，请参考 [平台差异说明](../7-platforms.1-platform-differences) 文档。

---

## 相关链接

- [WebComponent 组件](./5-api-reference.2-webcomponent) - Unity 组件封装
- [WebManager 架构](../4-core-concepts.1-web-manager) - 核心架构详解
- [请求结果类型](../4-core-concepts.2-result-types) - 结果类型详解
- [超时配置](../6-configuration.1-timeout) - 超时配置详解
- [基础数据配置](../6-configuration.2-base-data) - 基础数据配置详解
- [平台差异说明](../7-platforms.1-platform-differences) - 平台差异详解

...
本页收录 com.gameframex.unity.startup 仓库所有版本的变更记录,直接同步自仓库根目录的 CHANGELOG.md,不做扩写或解读。
...
| 1.4.2 | 2026-07-23 | Bug Fix | asmdef:补齐 Runtime 引用包的 versionDefines 宏定义 |
| 1.4.1 | 2026-07-22 | Bug Fix | deps:新增 systeminfo 依赖 |
| 1.4.0 | 2026-07-22 | Feature | startup:迁移至 GameEntry 组件访问模式 |
| 1.3.1 | 2026-07-22 | Bug Fix | deps:固定 unitask 依赖版本 |
| 1.3.0 | 2026-07-18 | Feature | startup:支持租户认证请求头 |
| 1.2.0 | 2026-07-06 | Feature | startup:新增 SkipRemoteStartupRequests 支持 WebGL 单机跳过远程启动请求 |
| 1.1.0 | 2026-07-03 | Feature | editor:启动配置 Inspector 显示字段 tooltip;startup:扩展 StartupOptions 字段与资源模式同步、后台认证头;startup:资源包 URL 优先使用服务端下发路径 |
| 1.0.1 | 2026-06-16 | Bug Fix | ci:更新 ci 配置 |
| 1.0.0 | 2026-06-16 | Feature | docs/http/startup 多个新增项,initial commit |

## 完整变更日志

以下为 [CHANGELOG.md](https://github.com/GameFrameX/com.gameframex.unity.startup/blob/main/CHANGELOG.md) 原文,自上而下为版本从新到旧。

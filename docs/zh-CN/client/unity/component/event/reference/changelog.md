...
本页收录 com.gameframex.unity.event 包的全部版本变更记录,内容摘自仓库根目录的 [CHANGELOG.md](https://github.com/GameFrameX/com.gameframex.unity.event/blob/main/CHANGELOG.md),按版本从新到旧排列,原文照录不做解读。
...
- 源文件:[CHANGELOG.md](https://github.com/GameFrameX/com.gameframex.unity.event/blob/main/CHANGELOG.md)
- 仓库:[GameFrameX/com.gameframex.unity.event](https://github.com/GameFrameX/com.gameframex.unity.event)

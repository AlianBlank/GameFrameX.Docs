...
本页收录 com.gameframex.unity.web 包自首次发布以来的全部版本变更，原文取自仓库根目录的 [CHANGELOG.md](https://github.com/GameFrameX/com.gameframex.unity.web/blob/main/CHANGELOG.md#L1-L145)，按时间倒序排列，未经任何扩写或解读。
...
- [CHANGELOG.md 源文件](https://github.com/GameFrameX/com.gameframex.unity.web/blob/main/CHANGELOG.md#L1-L145) — 本页内容的原始出处
- [GitHub Releases 对比视图](https://github.com/GameFrameX/com.gameframex.unity.web/compare) — 在线查看任意两个版本之间的完整差异

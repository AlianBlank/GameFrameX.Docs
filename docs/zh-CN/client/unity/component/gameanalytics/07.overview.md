...
2. **通过 Unity Package Manager**：在 Unity 编辑器中选择 `Window > Package Manager`，点击 `+` 号，选择 `Add package from git URL`，输入：`https://github.com/GameFrameX/com.gameframex.unity.gameanalytics.git`

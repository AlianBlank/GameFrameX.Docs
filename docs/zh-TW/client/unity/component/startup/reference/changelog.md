...
本頁面收錄了 com.gameframex.unity.startup 儲存庫的所有版本變更歷史，內容直接同步自儲存庫根目錄的 CHANGELOG.md，不包含額外的技術說明或詮釋。
...
| 1.4.2 | 2026-07-23 | Bug Fix | asmdef: 補齊 Runtime 參考套件的 versionDefines 巨集定義 |
| 1.4.1 | 2026-07-22 | Bug Fix | deps: 新增 systeminfo 相依性 |
| 1.4.0 | 2026-07-22 | Feature | startup: 移轉至 GameEntry 元件存取模式 |
| 1.3.1 | 2026-07-22 | Bug Fix | deps: 固定 unitask 相依性版本 |
| 1.3.0 | 2026-07-18 | Feature | startup: 支援租用戶驗證請求標頭 |
| 1.2.0 | 2026-07-06 | Feature | startup: 新增 SkipRemoteStartupRequests，以在 WebGL 單獨執行時跳過遠端啟動請求 |
| 1.1.0 | 2026-07-03 | Feature | editor: 啟動設定 Inspector 顯示欄位 tooltip；startup: 擴充 StartupOptions 欄位與資源模式同步、背景驗證標頭；startup: 資源包 URL 優先使用伺服器下發路徑 |
| 1.0.1 | 2026-06-16 | Bug Fix | ci: 更新 ci 設定 |
| 1.0.0 | 2026-06-16 | Feature | docs/http/startup 新增多個新項目，initial commit |

## 完整變更日誌

以下為 [CHANGELOG.md](https://github.com/GameFrameX/com.gameframex.unity.startup/blob/main/CHANGELOG.md) 的原文，由上而下依版本從新到舊排列。
...
來源：[CHANGELOG.md](https://github.com/GameFrameX/com.gameframex.unity.startup/blob/main/CHANGELOG.md)
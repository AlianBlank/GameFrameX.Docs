...
- 了解更多核心功能，请参阅 [获取本地化字符串](./4-core-features.get-string)
- 了解字典管理，请参阅 [字典管理](./4-core-features.dictionary-management)
- 了解语言切换机制，请参阅 [语言切换与事件](./4-core-features.language-switching)
- 查看完整 API，请参阅 [API 参考](./5-api-reference)

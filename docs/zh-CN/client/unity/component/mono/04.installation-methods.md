...
> **注意**：Mono 组件依赖于 Event 组件，请确保已安装 [com.alianblank.gameframex.unity.event](https://github.com/GameFrameX/com.alianblank.gameframex.unity.event)。
...
- [依赖组件：Event](https://github.com/GameFrameX/com.alianblank.gameframex.unity.event)

...
> **提示:** 有关安装说明，请参阅 [安装方式](./02.installation.md)。
...
- [插件介绍](./01.overview.md) - 了解更多关于事件系统的概述
- [安装方式](./02.installation.md) - 查看详细的安装说明
- [事件系统架构](./04.features.md) - 深入了解内部架构
- [EventComponent API 参考](./05.event-component.md) - 完整的 API 文档
- [EventManager API 参考](./06.event-manager.md) - 事件管理器 API
- [GameEventArgs API 参考](./07.game-event-args.md) - 事件参数基类
- [常见问题解答](./08.troubleshooting.md) - 常见问题与解决方案

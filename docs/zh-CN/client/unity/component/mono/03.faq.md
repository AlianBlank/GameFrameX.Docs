...
{
  "dependencies": {
    "com.alianblank.gameframex.unity.runtime": "https://github.com/AlianBlank/com.alianblank.gameframex.unity.runtime.git"
  }
}
```
...
4. 输入：`https://github.com/AlianBlank/com.gameframex.unity.mono.git`

...
- [IWebManager 接口](./5-api-reference.1-iwebmanager) - 网络请求管理器的接口定义
- [WebManager 架构](./4-core-concepts.1-web-manager) - WebManager 内部架构说明
- [请求结果类型](./4-core-concepts.2-result-types) - 详细的结果类型说明
- [超时配置](./6-configuration.1-timeout) - 超时配置详细说明
- [基础数据配置](./6-configuration.2-base-data) - 基础数据配置说明
